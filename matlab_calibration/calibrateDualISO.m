...
if(ISO == 800)
	...
	W_d = getFrameStatsStruct('data/w_dualiso_800','tiff',maxframes);
...
%% Shading correction
I_100_s = max((double(W_100.img  - B_100.img )) ./ double(saturationpoint - B_100.img ), 0);
